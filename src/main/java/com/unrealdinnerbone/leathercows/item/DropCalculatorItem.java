...
public class DropCalculatorItem extends Item {
    ...
    public static void onEntityClicked(PlayerEntity playerEntity, Hand hand, MobEntity aThis) {
        if(!playerEntity.world.isClient()) {
            ...
            if (playerEntity.getStackInHand(hand).getItem() instanceof DropCalculatorItem)
                if (aThis instanceof IDropperItemEntity) {
                    IDropperItemEntity iDropperItemEntity = (IDropperItemEntity) aThis;
